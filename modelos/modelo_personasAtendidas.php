<?php 
	...
	class Atendidas extends C_conexion
	{
		...
		public function insertarPA() {
			...
			$stmt = C_conexion::getConexion()->prepare("INSERT INTO atendidas (id_beneficiario,fecha,lugar,peso,talla,diagnostico,edad) VALUES (:id_beneficiario,:fecha,:lugar,:peso,:talla,:diagnostico,:edad)");
