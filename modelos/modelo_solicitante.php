<?php 
	...
	class Solicitante extends C_conexion
	{
		...
		public function ConsultaCI(){
			$stmt = C_conexion::getConexion()->prepare("SELECT * FROM solicitante WHERE cedula = :cedula");
		...
		public function actualizarPAS(){
			...
			$stmt = C_conexion::getConexion()->prepare("UPDATE solicitante SET tlf_movil= :tlf_movil,parroquia= :parroquia WHERE cedula = :cedula");
			$stmt->bindParam(":cedula",$this->cedula,PDO::PARAM_INT);
			$stmt->bindParam(":tlf_movil",$this->tlf_movil,PDO::PARAM_STR);
			$stmt->bindParam(":parroquia",$this->parroquia,PDO::PARAM_STR);
		...
		public function mostrarS($id_s){
			...
			$stmt = C_conexion::getConexion()->prepare("SELECT * FROM solicitante WHERE id_solicitante = :id_s");
